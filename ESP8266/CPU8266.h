...
public:
	Intruction INSRUCTIONS[131] = {
		...
		Intruction("l8ui",   0x000002, 0x00f00f, RRI8_disp),
		Intruction("l16si",  0x009002, 0x00f00f, RRI8_disp16),
		Intruction("l16ui",  0x001002, 0x00f00f, RRI8_disp16),
		...
		Intruction("movnez", 0x930000, 0xff000f, RRR),
		Intruction("mul16s", 0xd10000, 0xff000f, RRR),
		Intruction("mul16u", 0xc10000, 0xff000f, RRR),
		Intruction("mull",   0x820000, 0xff000f, RRR),
		Intruction("neg",    0x600000, 0xff0f0f, RRR_2rr),
		Intruction("nsa",    0x40e000, 0xfff00f, RRR_2r),
		Intruction("nsau",   0x40f000, 0xfff00f, RRR_2r),
		Intruction("nop",    0x0020f0, 0xffffff, NONE),
		Intruction("or",     0x200000, 0xff000f, RRR, new Or),
		Intruction("ret",    0x000080, 0xffffff, NONE),
		Intruction("rfe",    0x003000, 0xffffff, NONE),
		Intruction("rfi",    0x003010, 0xfff0ff, RRR_1imm),
		Intruction("rsil",   0x006000, 0xfff00f, RRR_immr),
		Intruction("rsr.epc1",      0x03b100, 0xffff0f, RSR_spec),
		Intruction("rsr.epc2",      0x03b200, 0xffff0f, RSR_spec),
		Intruction("rsr.epc3",      0x03b300, 0xffff0f, RSR_spec),
		Intruction("rsr.epc4",      0x03b400, 0xffff0f, RSR_spec),
		Intruction("rsr.epc5",      0x03b500, 0xffff0f, RSR_spec),
		Intruction("rsr.epc6",      0x03b600, 0xffff0f, RSR_spec),
		Intruction("rsr.epc7",      0x03b700, 0xffff0f, RSR_spec),
		Intruction("rsr.ps",        0x03e600, 0xffff0f, RSR_spec),
		Intruction("rsr.exccause",  0x03e800, 0xffff0f, RSR_spec),
		Intruction("rsr.ccount",    0x03e400, 0xffff0f, RSR_spec),
		Intruction("rsr.excvaddr",  0x03ee00, 0xffff0f, RSR_spec),
		Intruction("rsr.depc",      0x03c000, 0xffff0f, RSR_spec),
		Intruction("rsr.prid",      0x03eb00, 0xffff0f, RSR_spec),
		Intruction("rsr.ccompare0", 0x03f000, 0xffff0f, RSR_spec),
		Intruction("rsr.interrupt", 0x03e200, 0xffff0f, RSR_spec),
		Intruction("rsr.intenable", 0x03e400, 0xffff0f, RSR_spec),
		Intruction("rsr.sar",       0x030300, 0xffff0f, RSR_spec),
		Intruction("rsr.ddr",       0x036800, 0xffff0f, RSR_spec),
		Intruction("rsr",    0x030000, 0xff000f, RSR),
		Intruction("rsync",  0x002010, 0xffffff, NONE),
		Intruction("s8i",    0x004002, 0x00f00f, RRI8_disp),
		Intruction("s16i",   0x005002, 0x00f00f, RRI8_disp16),
		Intruction("s32i",   0x006002, 0x00f00f, RRI8_disp32, s32i),

		Intruction("sll",    0xa10000, 0xff00ff, RRR_sll),
		...
		Intruction("ssl",    0x401000, 0xfff0ff, RRR_ssa),
		Intruction("ssr",    0x400000, 0xfff0ff, RRR_ssa),
		...
		Intruction("waiti",  0x007000, 0xfff0ff, RRR_1imm),
		Intruction("wdtlb",  0x50e000, 0xfff00f, RRR_2r),
		Intruction("witlb",  0x506000, 0xfff00f, RRR_2r),
		Intruction("wsr.intenable", 0x13e400, 0xffff0f, RSR_spec),
		Intruction("wsr.litbase",   0x130500, 0xffff0f, RSR_spec),
		Intruction("wsr.vecbase",   0x13e700, 0xffff0f, RSR_spec),
		Intruction("wsr.ps",        0x13e600, 0xffff0f, RSR_spec),
		Intruction("wsr.epc1",      0x13b100, 0xffff0f, RSR_spec),
		Intruction("wsr.ccompare0", 0x13f000, 0xffff0f, RSR_spec),
		Intruction("wsr.intclear",  0x13e300, 0xffff0f, RSR_spec),
		Intruction("wsr.sar",       0x130300, 0xffff0f, RSR_spec),
		Intruction("wsr",    0x130000, 0xff000f, RSR),
		Intruction("xor",    0x300000, 0xff000f, RRR),
		...
		Intruction("mov.n",   0x000d, 0xf00f, RRRN_2r, movi),
		Intruction("break.n", 0xf02d, 0xf0ff, RRRN, new Breakn),
		Intruction("ret.n",   0xf00d, 0xffff, NNONE),
	...
	Register<uint32_t> REGISTERS[16] = {
		Register<uint32_t>(0),
		Register<uint32_t>(1),
		Register<uint32_t>(2),
		Register<uint32_t>(3),
		...
		Register<uint32_t>(8),
	    Register<uint32_t>(9),
		Register<uint32_t>(10),
		Register<uint32_t>(11),
		Register<uint32_t>(12),
		Register<uint32_t>(13),
		Register<uint32_t>(14),
		Register<uint32_t>(15),
	};
	...
	struct
	{
		Register<uint32_t>& epc1 = Register<uint32_t>("epc1");
		Register<uint32_t>& epc2 = Register<uint32_t>("epc2");
		Register<uint32_t>& epc3 = Register<uint32_t>("epc3");
		Register<uint32_t>& epc4 = Register<uint32_t>("epc4");
		Register<uint32_t>& epc5 = Register<uint32_t>("epc5");
		Register<uint32_t>& epc6 = Register<uint32_t>("epc6");
		Register<uint32_t>& epc7 = Register<uint32_t>("epc7");
		Register<uint32_t>& ps = Register<uint32_t>("ps");

		Register<uint32_t>& exccause  = Register<uint32_t>("exccause");
		Register<uint32_t>& ccount	  = Register<uint32_t>("ccount");
		Register<uint32_t>& excvaddr  = Register<uint32_t>("excvaddr");
		Register<uint32_t>& depc	  = Register<uint32_t>("depc");
		Register<uint32_t>& prid	  = Register<uint32_t>("prid");
		Register<uint32_t>& ccompare0 = Register<uint32_t>("ccompare0");
		Register<uint32_t>& interrupt = Register<uint32_t>("interrupt");
		Register<uint32_t>& intenable = Register<uint32_t>("intenable");

		Register<uint32_t>& sar = Register<uint32_t>("sar");
		Register<uint32_t>& ddr = Register<uint32_t>("ddr");
	} sr;
